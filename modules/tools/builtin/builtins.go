...
// NewSource returns a Source containing the standard builtin tools.
...
func NewSource(bus event.Bus, coord AskUserCoord, runner coretools.Runner) coretools.Source {
...
type builtinSource struct {
	bus    event.Bus
	coord  AskUserCoord
	runner coretools.Runner
}

func (s *builtinSource) Tools(ctx context.Context, turn coretools.TurnInfo) ([]coretools.Tool, error) {
